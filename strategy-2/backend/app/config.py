...
class Settings(BaseSettings):
    ...
    angel_quote_mode: str = "LTP"  # LTP | OHLC | FULL
    ...
    # MCX commodities for Strategy 2 grid — JSON list:
    # [{"key":"CRUDE_OIL","label":"Crude Oil","exchange":"MCX","token":"...","tradingsymbol":"...","lotsize":10}, ...]
    angel_mcx_instruments_json: str = ""
    # When false, LIVE mode logs grid signals but does not call Angel placeOrder.
    angel_live_trading_enabled: bool = True
