...
from app.services.breakout_trading_engine import start_breakout_engine_task, stop_breakout_engine_task
...
async def lifespan(_: FastAPI):
    ...
    start_breakout_engine_task()
    LOG.info("Strategy 4 backend startup complete")
    yield
    await stop_breakout_engine_task()
    stop_angel_auto_login_scheduler()


app = FastAPI(title="Strategy 4 API", lifespan=lifespan)
