...
class TradePosition(Base):
    ...
    put_sl_pts: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    call_sl_pts: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    sl_mode: Mapped[str] = mapped_column(String(16), nullable=False, default="auto")
    underlying_at_entry: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    ...
    trading_symbol: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
    symbol_token: Mapped[Optional[str]] = mapped_column(String(32), nullable=True)
    order_id: Mapped[Optional[str]] = mapped_column(String(64), nullable=True)
    unique_order_id: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
    last_order_message: Mapped[Optional[str]] = mapped_column(String(512), nullable=True)
...
class TradingLog(Base):
    ...
    symbol: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
