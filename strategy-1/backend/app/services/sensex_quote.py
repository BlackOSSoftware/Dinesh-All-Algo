...
def fetch_sensex_live_quote(*, exchange_tokens: dict[str, list[str]], mode: str) -> dict[str, Any]:
    ...
    return {
        ...
        "unfetched": unfetched,
        "as_of": time.time(),
        # Session window independent of live LTP success (needed for Generate Token detection).
        "market_open": session_open,
        "price_type": price_type,
        "quote_source": quote_source,
        "token_expired": _is_token_error(msg) or stale_during_session,
    }
